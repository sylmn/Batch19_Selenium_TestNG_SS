...
public class TestBase {
    ...
    protected WebDriver driver;  // access modifies Default olduğu için extend edildiğinde diğer class larda görülmez
...
//        String reportPath = projectPath + "/test-output/report.html";
    ...
    public void tearDown(ITestResult result) throws IOException {
        ...
        if (result.getStatus() == ITestResult.FAILURE){
            //başarısız tetin adını alalım
            extentLogger.fail(result.getName());
            //ekran görüntüsü ve kayıt edildiği yeri belirleyelim.
            String screenShotPath = BrowserUtils.getScreenshot(result.getName());
            //screen shot'ı rapora ekleyelim

...
public class C01_OpenBrowser {
    public static void main(String[] args) {
        ...
        WebDriver driver = new ChromeDriver(); //polymorfik bir tanimla
        ...
        String expectedTitle="Amazon.com.tr: Elektronik, bilgisayar, akıllı telefon, kitap, oyuncak, yapı market, ev, mutfak, " +
                "oyun konsolları ürünleri ve daha fazlası için internet alışveriş sitesi";
